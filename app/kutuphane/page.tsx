...
const MOCK_ARTICLES: Article[] = [
  ...
  {
    id: "5",
    title: "User Interview Nasıl Yapılır?",
    titleEn: "Conducting User Interviews",
    slug: "user-interview-nasil-yapilir",
    description: "Doğru soruları sorarak derinlemesine içgörüler elde etme yöntemleri. Görüşme öncesi hazırlıktan analiz aşamasına kadar.",
    category: "ux-research",
    readingTime: 14,
    featured: false,
