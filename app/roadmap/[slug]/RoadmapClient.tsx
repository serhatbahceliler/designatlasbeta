                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  {credits.linkedin && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#0A66C2] hover:bg-[#004182] text-white text-sm font-semibold rounded-lg transition-colors duration-300"
                    >
