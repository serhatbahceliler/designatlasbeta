        ...
        <section className="py-12 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-8 bg-gradient-to-br from-zinc-900 to-zinc-900/50 border border-[#DEFF37]/20 rounded-xl hover:border-[#DEFF37]/40 transition-all duration-300">
                <div className="flex items-center gap-6">
                  {/* Photo */}
                  <img
                    src={credits.photo}
                    alt={credits.name}
                    className="w-32 h-32 rounded-lg border-2 border-[#DEFF37]/30 object-cover flex-shrink-0"
                  />
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {credits.linkedin && (
                      <a
                        ...
                        className="text-[#0A66C2] hover:text-[#004182] text-lg font-medium transition-colors duration-300 inline-flex items-center gap-2"
                      >
