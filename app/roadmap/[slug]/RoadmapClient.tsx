              ...
              <div className="p-10 bg-gradient-to-br from-zinc-900 to-zinc-900/50 border border-[#DEFF37]/20 rounded-xl hover:border-[#DEFF37]/40 transition-all duration-300">
                <div className="flex items-start gap-8">
                  ...
                  <img
                    src={credits.photo}
                    alt={credits.name}
                    className="w-40 h-40 rounded-xl border-2 border-[#DEFF37]/30 object-cover flex-shrink-0"
                  />
                  ...
                  <div className="flex-1 min-w-0 flex flex-col pt-2">
                    ...
                    {credits.linkedin && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0A66C2] hover:bg-[#004182] text-white text-base font-semibold rounded-lg transition-colors duration-300 w-fit"
                      >
