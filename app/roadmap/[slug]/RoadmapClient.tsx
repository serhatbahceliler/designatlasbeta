                                  ...
                                  <li key={itemIdx}>
                                    {item.url ? (
                                      <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-between gap-2 text-gray-300 hover:text-[#DEFF37] transition-colors group"
                                      >
                                        <span className="text-sm underline">{item.title}</span>
                                        <svg className="w-4 h-4 text-gray-400 group-hover:text-[#DEFF37] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
