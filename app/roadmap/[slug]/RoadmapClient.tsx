              ...
              <div className="p-6 bg-gradient-to-br from-zinc-900 to-zinc-900/50 border border-[#DEFF37]/20 rounded-xl hover:border-[#DEFF37]/40 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <img
                    src={credits.photo}
                    alt={credits.name}
                    className="w-20 h-20 rounded-lg border-2 border-[#DEFF37]/30 object-cover flex-shrink-0"
                  />
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {credits.linkedin && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#0A66C2] hover:bg-[#004182] text-white text-xs font-semibold rounded-lg transition-colors duration-300"
                      >
