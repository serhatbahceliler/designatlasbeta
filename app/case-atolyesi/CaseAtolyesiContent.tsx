                      ...
                      <div className="bg-zinc-800 text-white rounded-2xl px-5 py-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="relative flex-shrink-0 flex items-center justify-center w-10 h-10">
                            {/* Outer rotating ring - centered around icon */}
                            <div className="absolute inset-0 w-10 h-10 border-2 border-purple-500/30 border-t-purple-500 rounded-full animate-spin"></div>
