...
export const MOCK_ARTICLES: Article[] = [
  {
    ...
    heroImage: "https://r.resimlink.com/fAILNYl6ES.png",
    author: "DesignAtlas",
    views: 1250,
  },
  {
    id: "portfolio-case-study",
    title: "Portfolyo Case Study Nasıl Yazılır?",
    ...
    featured: true,
    publishedAt: "2025-01-13",
    heroImage: "https://r.resimlink.com/sFgdlrj5X31.png",
    author: "DesignAtlas",
    views: 2100,
  },
  {
    ...
    subtitle: "Tasarım Sistemleri Oluşturma Rehberi",
    titleEn: "What is Design System?",
    slug: "design-system-nedir",
    description: "Design System nedir, neden önemlidir? Tasarım sistemi nasıl oluşturulur, hangi bileşenleri içerir? Design token, component library ve pattern library rehberi.",
    category: "ux-design",
    readingTime: 14,
    featured: true,
    publishedAt: "2025-01-24",
    heroImage: "https://r.resimlink.com/fBxuesjRMHn.png",
    author: "DesignAtlas",
    views: 0,
  },
  {
    ...
    titleEn: "Figma Fundamentals",
    slug: "figma-temelleri",
    description: "Figma nasıl kullanılır? Başlangıç seviyesinden itibaren Figma'nın temel özellikleri, araçları ve iş akışları. Pratik örneklerle adım adım Figma rehberi.",
    category: "araclar-ipucu",
    readingTime: 16,
    featured: true,
    publishedAt: "2025-01-24",
    heroImage: "https://r.resimlink.com/A_ukVEI63.png",
    author: "DesignAtlas",
    views: 0,
  },
  {
