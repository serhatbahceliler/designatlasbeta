        ...
        <div className="p-8 max-h-[90vh] overflow-y-auto">
          ...
          {activeTab === "login" && (
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label htmlFor="loginEmail" className="block text-sm font-medium text-white mb-2">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="loginPassword" className="block text-sm font-medium text-white mb-2">
                  Şifre
                </label>
                <input
                  type="password"
          ...
          {activeTab === "signup" && (
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="signupFirstName" className="block text-sm font-medium text-white mb-2">
                    Ad
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="signupLastName" className="block text-sm font-medium text-white mb-2">
                    Soyad
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="signupConfirmPassword" className="block text-sm font-medium text-white mb-2">
                  Şifre Tekrar
                </label>
                <input
                  type="password"
